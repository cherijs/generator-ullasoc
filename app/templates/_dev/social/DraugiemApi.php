	...
	*/
	...
	public function cookieFix(){
		...
		// Safari cookie unlocker
			if(empty($_COOKIE[session_name()]) && strpos($agent,'Safari') && isset($_GET['dr_auth_code']) && !isset($_GET['dr_cookie_fix'])){
			echo '<html><head>
		...
		// MSIE cookie block: http://stackoverflow.com/questions/389456/ (jāsūta katru reizi, kad setosim cepumu uz IE6/7/8 caur iFrame)
